---
name: generating-support-persona
description: "Use when generating a project-specific customer-support assistant persona from the reference template \u2014 turning a harnessed product's knowledge base and tool catalog into a finished persona.md for the runtime support agent. Triggers: \"generate the support persona\", \"make the assistant persona for <project>\", part of setting up a support agent."
---
